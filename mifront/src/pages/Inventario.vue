...
<!--        <pre>{{$store.getters["login/productos"]}}</pre>-->
    ...
    <q-dialog v-model="store.dialogCreateProducto" position="right" full-height :maximized="true">
      <q-card style="width: 450px; max-width: 80vw;">
        <q-card-section class="row items-center q-pb-none">
    ...
    <q-dialog v-model="store.dialogCreateCategoria" position="right" full-height :maximized="true">
      <q-card style="width: 450px; max-width: 80vw;">
        <q-card-section class="row items-center q-pb-none">
          <div class="text-h6">Crear categoría</div>
          <q-space />
  ...
  methods:{
    ...
    createCategoria(){
      ...
      this.$api.post('categoria',this.categoria).then(res=>{
        this.$q.loading.hide()
        this.miscategorias()
        this.store.dialogCreateCategoria=false
        this.categoria={}
      }).catch(err => {
        this.$q.loading.hide()
        this.$q.notify({
